...
print('A =', A)
# PolynomialFeatures(x, y) : 입력값 x,y를 다항식으로 변환   -> x^2, xy, y^2, b
# degree: 차수
# interaction_only: True이면 2차항에서 상호작용항(xy)만 출력  /  False(default)이면 이차항 모두 출력(x^2, y^2, xy)
# include_bias: 상수항(b) 생성 여부
...
print('intercept(절편):', lin_reg.intercept_)
print('coefficients(계수):', lin_reg.coef_)
# y = b + a1 * x + a2 * x^2
